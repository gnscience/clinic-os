(function () {
  ...
  if (!reduceMotion && "IntersectionObserver" in window) {
    var targets = document.querySelectorAll(
      ".pillar-card, .pack-card, .qa-card, .team-card, .shadow-steps li, .trust-grid li, .demo-panel, .stack-diagram, .hitl-banner, .demo-link-panel, .cta-band"
    );
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      if (interest === "investor") subject = "GNScience investor conversation";
